#pragma once
#include <lyrahgames/xstd/static_zstring_list.hpp>
...
requires static_zstring_list<strings...>::is_set  //
...
/// the given type is a static identifier list.
///
template <typename list>
constexpr bool is_static_identifier_list =
    detail::is_static_identifier_list<list>::value;
...
/// is a static identifier list.
///
template <typename T>
concept static_identifier_list = is_static_identifier_list<T>;
...
//
namespace meta::static_identifier_list {

// The static identifier list is only an alias of a values list.
// So, all value list meta functions are enabled by using its namespace.
//
using namespace static_zstring_list;
