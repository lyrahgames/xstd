...
//   static constexpr bool contains = meta::equal<U, types> || ...;
...
struct type_list<T, types...> {
  ...
  // types...>::type;
  using element = typename detail::type_list::element<index, T, types...>::type;
...
struct reverse<type_list<t, types...>> {
  using type = typename push_back<typename reverse<types...>::type, t>::type;
};
